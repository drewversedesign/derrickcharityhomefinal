...
const Impact = () => {
  ...
  return <section id="impact" className="py-16 md:py-24 bg-gray-50 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="p-6 md:p-10 flex flex-col justify-center">
              ...
              <div className="flex flex-wrap gap-4 mt-2">
                <Button onClick={scrollToContact} className="bg-yellow-500 hover:bg-yellow-400 text-gray-900">
                  Support Our Mission
                </Button>
              </div>
            </div>
            <div className="h-[300px] lg:h-auto overflow-hidden">
              <img alt="Derrick Charity Home Founder" className="w-full h-full object-cover object-center" src="https://github.com/drewversedesign/Derrick-Charity-Home/blob/main/IMG-20250518-WA0045.jpg?raw=true" />
            </div>
          </div>
        </div>
      </div>
